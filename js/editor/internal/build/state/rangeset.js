...
export class RangeSet {
    ...
    static { this.empty = new RangeSet([], [], null, -1); }
}
...
class SpanCursor {
    ...
    // After calling this, if `this.point` != null, the next range is point. Otherwise, it's a regular range, covered by `this.active`.
    next() {
