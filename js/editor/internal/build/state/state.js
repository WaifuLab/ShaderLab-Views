...
export class EditorState {
     ...
     */
    static { this.allowMultipleSelections = allowMultipleSelections; }
    /**
     ...
     */
    static { this.tabSize = Facet.define({
     ...
     */
    static { this.lineSeparator = lineSeparator; }
     ...
     */
    static { this.phrases = Facet.define({
        compare(a, b) {
    ...
    static { this.languageData = languageData; }
     ...
     */
    static { this.changeFilter = changeFilter; }
    /**
     ...
     */
    static { this.transactionFilter = transactionFilter; }
    /**
     ...
     */
    static { this.transactionExtender = transactionExtender; }
}
