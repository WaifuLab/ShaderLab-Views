...
import { ViewPlugin, EditorView, logException } from "../view/index.js";
/**
...
export class Language {
    ...
    name = "") {
        this.data = data;
        this.name = name;
        // Kludge to define EditorState.tree as a debugging helper, without the EditorState
        // package actually knowing about languages and lezer trees.
    ...
    // @internal
    static { this.setState = StateEffect.define(); }
}
...
const isInputPending = typeof navigator != "undefined" && navigator.scheduling?.isInputPending ?
