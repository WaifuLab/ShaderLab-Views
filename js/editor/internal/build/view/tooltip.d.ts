import { EditorState, Transaction, StateEffect, Facet, Extension } from "../state/index.js";
 ...
 */
export declare function tooltips(config?: {
...
/**
 * Describes a tooltip. Values of this type, when provided through the {@link showTooltip} facet,
 * control the individual tooltips on the editor.
 */
...
export declare const showTooltip: Facet<Tooltip | null, readonly (Tooltip | null)[]>;
/**
 ...
 */
export declare function hoverTooltip(source: (view: EditorView, pos: number, side: -1 | 1) => Tooltip | null | Promise<Tooltip | null>, options?: {
    hideOn?: (tr: Transaction, tooltip: Tooltip) => boolean;
    hideOnChange?: boolean | "touch";
    hoverTime?: number;
}): Extension;
/** Get the active tooltip view for a given tooltip, if available. */
export declare function getTooltip(view: EditorView, tooltip: Tooltip): TooltipView | null;
/** Returns true if any hover tooltips are currently active. */
export declare function hasHoverTooltips(state: EditorState): boolean;
/** Transaction effect that closes all hover tooltips. */
export declare const closeHoverTooltips: StateEffect<null>;
/**
 ...
 */
export declare function repositionTooltips(view: EditorView): void;
