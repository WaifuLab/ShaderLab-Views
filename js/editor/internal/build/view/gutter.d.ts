import { Facet, Extension, EditorState, RangeValue, RangeSet } from "../state/index.js";
...
export declare abstract class GutterMarker extends RangeValue {
    compare(other: GutterMarker): boolean;
 ...
 */
export declare const gutterLineClass: Facet<RangeSet<GutterMarker>, readonly RangeSet<GutterMarker>[]>;
...
/**
 * Returns an extension that adds a `cm-activeLineGutter` class to all gutter elements on the
 * [active line]{@link highlightActiveLine}.
 */
