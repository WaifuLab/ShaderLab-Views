...
export const undo = cmd(0 /* BranchName.Done */, false);
/** Redo a group of history events. Returns false if no group was available. */
export const redo = cmd(1 /* BranchName.Undone */, false);
/** Undo a change or selection change. */
export const undoSelection = cmd(0 /* BranchName.Done */, true);
/** Redo a change or selection change. */
export const redoSelection = cmd(1 /* BranchName.Undone */, true);
function depth(side) {
...
export const undoDepth = depth(0 /* BranchName.Done */);
/** The amount of redoable change events available in a given state. */
export const redoDepth = depth(1 /* BranchName.Undone */);
...
class HistEvent {
    ...
    effects, 
    // Accumulated mapping (from addToHistory==false) that should be applied to events below this one.
    mapped, 
...
/**
 * Add a mapping to the top event in the given branch. If this maps away all the changes and effects
 * in that item, drop it and propagate the mapping to the next item.
 */
...
class HistoryState {
    ...
    static { this.empty = new HistoryState(none, none); }
}
/**
