...
export const completionPlugin = ViewPlugin.fromClass(class implements PluginValue {
    ...
    update(update: ViewUpdate) {
        ...
        if (this.debounceUpdate > -1) window.clearTimeout(this.debounceUpdate)
    ...
    scheduleAccept() {
        ...
        else if (this.debounceAccept < 0) this.debounceAccept = window.setTimeout(() => this.accept(), DebounceTime)
    }
