...
// Don't compute precise column positions for line offsets above this (since it could get expensive).
// Assume offset==column for them.
const MaxOff = 2000
 ...
 */
export function crosshairCursor(options: {key?: "Alt" | "Control" | "Shift" | "Meta"} = {}): Extension {
