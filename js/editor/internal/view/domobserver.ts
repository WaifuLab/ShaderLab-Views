...
import {hasSelection, getSelection, DOMSelectionState, isEquivalentPosition, deepActiveElement,
        dispatchKey, atElementStart} from "./dom"
...
export class DOMObserver {
    ...
    constructor(private view: EditorView) {
        ...
        if (typeof IntersectionObserver == "function") {
            this.intersection = new IntersectionObserver(entries => {
                if (this.parentCheck < 0) this.parentCheck = window.setTimeout(this.listenForScroll.bind(this), 1000)
    ...
    onResize() {
        if (this.resizeTimeout < 0) this.resizeTimeout = window.setTimeout(() => {
