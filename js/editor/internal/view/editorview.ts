import {EditorState, Transaction, TransactionSpec, Extension, Prec, ChangeDesc, EditorSelection,
        SelectionRange, StateEffect, Facet, Line, EditorStateConfig} from "../state/index"
...
import {ViewUpdate, styleModule, contentAttributes, editorAttributes, AttrSource, clickAddsSelectionRange,
        ...
        ViewPlugin, PluginValue, PluginInstance, decorations, atomicRanges, scrollMargins, MeasureRequest,
        editable, inputHandler, perLineTextDirection, scrollIntoView, UpdateFlag, ScrollTarget} from "./extension"
