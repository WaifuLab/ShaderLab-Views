...
function iterMatches(doc: Text, re: RegExp, from: number, to: number, func: (from: number, m: RegExpExecArray) => void) {
    re.lastIndex = 0
...
export class MatchDecorator {
    ...
    private addMatch: (match: RegExpExecArray, view: EditorView, from: number, add: (from: number, to: number, deco: Decoration) => void) => void
