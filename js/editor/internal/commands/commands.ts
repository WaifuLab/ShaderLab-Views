...
export const cursorSyntaxLeft: Command = view => moveSel(view, range => moveBySyntax(view.state, range, !ltrAtCursor(view)))
/** Move the cursor over the next syntactic element to the right. */
export const cursorSyntaxRight: Command = view => moveSel(view, range => moveBySyntax(view.state, range, ltrAtCursor(view)))
...
export const cursorLineBoundaryLeft: Command = view => moveSel(view, range => moveByLineBoundary(view, range, !ltrAtCursor(view)))
...
export const selectLineBoundaryLeft: Command = view => extendSel(view, range => moveByLineBoundary(view, range, !ltrAtCursor(view)))
