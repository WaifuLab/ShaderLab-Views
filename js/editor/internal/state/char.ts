...
// Each pair of elements represents a range, as an offet from the previous range and a length.
// Numbers are in base-36, with the empty string being a shorthand for 1.
